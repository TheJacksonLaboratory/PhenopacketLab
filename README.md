...
The Single-page application can be accessed at the following URL: http://35.229.81.196/dashboard 
The Spring Boot RESTful API which serves the application with all the necessary ontologies can be found at this URL: http://34.75.209.93:8080/swagger-ui/index.html

...
export class PhenotypicFeatureData {
    ...
    constructor() {
        ...
        phenotypicFeature1.evidence = new Evidence(new OntologyClass('', ''));
        ...
        phenotypicFeature0.evidence = new Evidence(new OntologyClass('', ''));
        ...
        phenotypicFeature3.evidence = new Evidence(new OntologyClass('', ''));
        ...
        phenotypicFeature4.evidence = new Evidence(new OntologyClass('', ''));
        ...
        phenotypicFeature2.evidence = new Evidence(new OntologyClass('', ''));

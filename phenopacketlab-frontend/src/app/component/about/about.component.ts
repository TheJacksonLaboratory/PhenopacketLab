...
export class AboutComponent implements OnInit {
  ...
  contacts: Contact[] =
      [
        ...
        {name: 'Sejal Desai B.S.', title: 'Manager, Software Quality Assurance',
            external_link: 'https://www.jax.org/people/sejal-desai',
            email: 'sejal.desai@jax.org', src: 'assets/img/sejal-desai.jpeg'},

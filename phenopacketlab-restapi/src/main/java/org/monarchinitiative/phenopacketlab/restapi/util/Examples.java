...
public class Examples {
            ...
            return Family.newBuilder()
                    ...
                    .setPedigree(Pedigree.newBuilder()
                            ...
                            .addPersons(Pedigree.Person.newBuilder() // proband
                                    ...
                                    .build())
                            .build())
                    .setMetaData(prepareMetadata(CREATED, ExternalReference.newBuilder()
                            .setId("PMID:29715184")
    ...
    public static class Cohorts {
        private static final Instant CREATED = Instant.parse("2022-03-14T00:00:00.000Z");
        private Cohorts() {}

        public static Cohort toyNeurofibromatosisCohort() {
            return Cohort.newBuilder()
                    .setId("toy-neurofibromatosis-cohort")
                    .setDescription("Example cohort of patients diagnosed with Neurofibromatosis type 1")
                    // 1a
                    .addMembers(Phenopacket.newBuilder()
                            .setId("1a")
                            .setSubject(Individual.newBuilder()
                                    .setId("1a")
                                    .setTimeAtLastEncounter(isoAge("P17Y"))
                                    .setTaxonomy(ontologyClass("NCBITaxon:9606", "Homo sapiens"))
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0000957", "Cafe-au-lait spot"))
                                    .setOnset(TimeElement.newBuilder().setOntologyClass(ontologyClass("HP:0003623", "Neonatal onset")).build())
                                    .addEvidence(Evidence.newBuilder().setEvidenceCode(ontologyClass("ECO:0006017", "author statement from published clinical study used in manual assertion")).build())
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0001263", "Global developmental delay"))
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0001067", "Neurofibromas"))
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0001250", "Seizure"))
                                    .setExcluded(true)
                                    .build())
                            .addDiseases(Disease.newBuilder()
                                    .setTerm(ontologyClass("OMIM:162200", "NEUROFIBROMATOSIS, TYPE I; NF1"))
                                    .setOnset(TimeElement.newBuilder().setOntologyClass(ontologyClass("HP:0003623", "Neonatal onset")).build())
                                    .build())
                            .build())
                    // 1b
                    .addMembers(Phenopacket.newBuilder()
                            ...
                            .setSubject(Individual.newBuilder()
                                    .setId("1b")
                                    .setTimeAtLastEncounter(isoAge("P46Y"))
                                    .setTaxonomy(ontologyClass("NCBITaxon:9606", "Homo sapiens"))
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0000957", "Cafe-au-lait spot"))
                                    .setOnset(TimeElement.newBuilder().setOntologyClass(ontologyClass("HP:0011463", "Childhood onset")).build())
                                    .addEvidence(Evidence.newBuilder().setEvidenceCode(ontologyClass("ECO:0006017", "author statement from published clinical study used in manual assertion")).build())
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0001263", "Global developmental delay"))
                    ...
                    .addMembers(Phenopacket.newBuilder()
                            ...
                            .setSubject(Individual.newBuilder()
                                    .setId("2a")
                                    .setTimeAtLastEncounter(isoAge("P26Y"))
                                    .setTaxonomy(ontologyClass("NCBITaxon:9606", "Homo sapiens"))
                                    .build())
                            .addPhenotypicFeatures(PhenotypicFeature.newBuilder()
                                    .setType(ontologyClass("HP:0000957", "Cafe-au-lait spot"))
                    ...
                    .setMetaData(prepareMetadata(CREATED, ExternalReference.newBuilder()
                            .setId("PMID:17726231")
                            .setDescription("Novel Mutations in the NF1 Gene in Czech Patients With Neurofibromatosis Type 1")
                            .setReference("https://pubmed.ncbi.nlm.nih.gov/17726231")
                            .build()))
                    .build();
        }
    }

    private static MetaData prepareMetadata(Instant created, ExternalReference externalReference) {
    ...
    private static TimeElement isoAge(String iso8601Duration) {
        return TimeElement.newBuilder()
                .setAge(Age.newBuilder()
                        .setIso8601Duration(iso8601Duration)
                        .build())
                .build();
    }
